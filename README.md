...
Universal Token ID Registry for bots and users:

- **Registry**: [ai.farnsworth.cloud/bot-tracker](https://ai.farnsworth.cloud/bot-tracker)
- **Register**: [ai.farnsworth.cloud/bot-tracker/register](https://ai.farnsworth.cloud/bot-tracker/register)
- **API Docs**: [ai.farnsworth.cloud/bot-tracker/docs](https://ai.farnsworth.cloud/bot-tracker/docs)
...
```
GET /api/bot-tracker/verify/{token_id}
```

Any service can verify bot/user identity through the Bot Tracker API.
