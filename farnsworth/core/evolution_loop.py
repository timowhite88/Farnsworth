...
"""
        ...
        # For complex/critical tasks or when assigned to Grok/Claude/ClaudeOpus, use APIs
        if complexity in ("complex", "critical") or task.assigned_to in ("Grok", "Claude", "ClaudeOpus"):
...
- Active agents: Grok, Gemini, Kimi, Claude (Sonnet), ClaudeOpus (Opus 4.6), DeepSeek (local 8B), Phi4 (local 9B)
...
- Key modules: core/nexus.py (event bus, 1373 lines), memory/ (7 layers, 20 files), core/model_swarm.py (PSO, 1134 lines), evolution/ (genetics + quantum)
...
---"""
    ...
    def _parse_task_format(self, text: str, spawner) -> List[Dict]:
        ...
        valid_agents = {"Grok", "Gemini", "Kimi", "Claude", "ClaudeOpus", "DeepSeek", "Phi", "OpenCode", "Farnsworth"}
